(function () {
  ...
  $(document).ready(function() {
    ...
    $("#feedbackSubmit").click(function() {
      ...
      $.ajax({
        url: "//formspree.io/h.absil@hotmail.fr",
        method: "POST",
        dataType: "json",
        data: $("#feedbackForm").serialize(),
        success: function(data) {
          contactFormUtils.addAjaxMessage("Le message a bien été envoyé", false);
          contactFormUtils.clearForm();
        },
        error: function(response) {
          contactFormUtils.addAjaxMessage("Une erreur a été détectée dans le formulaire. Veuillez revérifiez les paramètres entrés.", true);
        },
        complete: function() {
          $btn.button('reset');
        }
